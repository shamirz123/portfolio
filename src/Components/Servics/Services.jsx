            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="p-3 services-detail js-scroll slide-left">
                ...
                <div className="p-2  ">
                  ...
                  <p>
                    Offer custom website development services tailored to the
                    specific needs and goals of businesses.
                  </p>
                </div>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="p-3 services-detail js-scroll slide-right ">
                ...
                <div className="p-2 ">
                  ...
                  <p>
                    Develop mobile applications to complement websites or offer
                    standalone services.
                  </p>
                </div>
                <div className="detail-btn-div">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="p-3 services-detail js-scroll slide-left">
                ...
                <div className="p-2 ">
                  ...
                  <p>
                    Optimize website and application performance to ensure fast
                    loading times.
                  </p>
                </div>
                <div className="detail-btn-div">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <div className="p-3 services-detail js-scroll slide-right ">
                ...
                <div className="p-2 ">
                  ...
                  <p>
                    Focus on creating a positive and intuitive user experience
