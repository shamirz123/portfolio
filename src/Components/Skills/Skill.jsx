                ...
                <div className="skill-wrapper">
                    <div className="row">
                        <div className="col-lg-6 col-md-8 col-sm-6 mt-2">
                            ...
                            <p>With a solid foundation in languages like JavaScript and proficiency in frameworks such as React and Node.js, I've honed my skills to create dynamic and responsive web solutions. Over the past three years, I've successfully completed over 50 projects, gaining invaluable experience and a keen eye for detail.</p> */}
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-sm-6 col-md-6">
                                    <div className="language-section">
                                        ...
                                        <button className='m-0 pl-0'>85%</button>
                                    </div>
                                </div>
                                <div className="col-lg-4 col-sm-6 col-md-6">
